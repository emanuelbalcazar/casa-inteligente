...
class Humidity extends Handler {

    /**
     * Creates an instance of Humidity.
     * @memberof Humidity
     */
    constructor() {
        super();
    ...
    execute(value, machines, callback) {
        ...
        async.map(machines, function (machine, callback) {
            ...
            for (var i = 0; i < transitions.length; i++) {
                ...
                if ((value >= transitions[i].min) && (value <= transitions[i].max) && (transitions[i].type == HUMIDITY)) {
